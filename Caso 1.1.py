...
def feat_mchart(df,ft_type):
    ...
    df.rename(columns = { ft_type_x1 : "Max val abs-Mancal 1-x", ft_type_y1 : "Max val abs-Mancal 1-y", ft_type_x2:"Max val abs-Mancal 2-x",ft_type_y2:"Max val abs-Mancal 2-y"}, inplace = True)
