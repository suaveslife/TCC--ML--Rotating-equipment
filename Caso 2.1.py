...
def featchart(df):
    ...
    ax1.set(xlabel="Máximo valor absoluto-Mancal 1-x", ylabel="Máximo valor absoluto-Mancal 1-y")
           
    ax2 =sns.relplot(x="rms_x1", y="rms_y1", hue="class name", data=df);
    ax2.set(xlabel="RMS-Mancal 1-x", ylabel="RMS-Mancal 1 -y")
         
    ax3 =sns.relplot(x="energy_x1", y="energy_y1", hue="class name", data=df);
    ax3.set(xlabel="energy-Mancal 1-x", ylabel="energy-Mancal 1-y")
           
    ax4 =sns.relplot(x="energy_moment_x1", y="energy_moment_y1", hue="class name", data=df);
    ax4.set(xlabel="energy moment-Mancal 1-x", ylabel="energy moment-Mancal 1-y")
    
def featchart3d(df,ft_type):
    ...
    ax.set_xlabel(ft_type_x1)
    ax.set_ylabel(ft_type_y1)
    ax.set_zlabel(ft_type_x2)
    
    sc1 = ax1.scatter(x, y, z, s=40, c=x, marker='o', cmap=cmap, alpha=1)
    ax1.set_xlabel(ft_type_x1)
    ax1.set_ylabel(ft_type_y1)
    ax1.set_zlabel(ft_type_y2)
